...
import { faLocationDot,faCircleXmark,faCircleArrowLeft,
      ...
      <div className="hotelContainer">
        ...
        <div className="hotelWrapper">
          ...
          <div className="hotelAddress">
            ...
            <span>Elton Se 126 New York</span>
            </div>
            <span className="hotelDistance">
              Excellent location - 300m form center
            </span>
            ...
            <div className="hotelDetails">
              <div className="hotelDetailsTexts">
                <h1 className="hotelTitle">Stay in the heart of City Grand</h1>
